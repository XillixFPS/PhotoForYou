<!-- Cette page permet de s'inscrire en tant que PHOTOGRAPHE -->
...
<html>
<head>
	<title>Inscription(Photographe) - PhotoForYou</title>
</head>

<div class="container">
<!--Début Formulaire-->
 <!-- Formulaire d'inscription -->
 <form  method="post" action="inscription-photographe.php" id="form" enctype="multipart/form-data" novalidate>
 <fieldset>
        <legend>Inscription Photographe</legend>
    ...
    <div class="form-group row">
      <div class="col-md-4 mb-3">
        ...
        <input type="text" class="form-control" pattern="[a-zA-ZàâæçéèêëîïôœùûüÿÀÂÆÇnÉÈÊËÎÏÔŒÙÛÜŸ-]+" autocomplete="off"  spellcheck="false" name="nom"  minlength="3" maxlength="45" id="nom" placeholder="Votre nom" required>
        <div class="valid-feedback">
          Nom Ok !
        </div>
        <div class="invalid-feedback">
    ...
    <div class="form-group row">
      <div class="col-md-4 mb-3">
        ...
        <input type="email" class="form-control" name="email" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$" id="email" placeholder="nom@exemple.com" required>
   ...
   <div class="form-group row">
    ...
    <div class="form-group row">
        ...
        <label for="siret" id="siret">Numéro de siret</label>
        <div class="form-group">
          <input type="text" class="form-control col-md-3" name="siret" id="siret" placeholder="Exemple : 12345678900013" pattern="[0-9]{14}" maxlength="14"required>
        </div>
        <div class="invalid-feedback">
      ...
      <div class="form">
          ...
          <input type="date" class="form-control col-md-3" name="dateNaissance" placeholder="DD/MM/YYY" required/>
          <div class="invalid-feedback">
